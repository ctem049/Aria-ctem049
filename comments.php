		 ...
		 role="form">
			...
			<div id="comment-info">
				...
				<p class="comment-input">
					...
					<input placeholder="<?php echo $this->options->commentsRequireMail ? '（必填）' : '（选填）';echo '邮箱(QQ号@qq.com 有qq头像哦)'; ?>" type="email" name="mail" id="mail" class="text" value="<?php $this->remember('mail'); ?>"
